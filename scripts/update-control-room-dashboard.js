...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    @media (max-width:600px) { html,body { width:100%; max-width:100%; min-width:0; overflow-x:hidden; margin:0; padding:0; } main,.wrap,.page,.shell,.container { display:block; width:100%; max-width:100%; min-width:0; margin-left:auto; margin-right:auto; padding-left:12px; padding-right:12px; box-sizing:border-box; overflow-x:hidden; } .report-canvas,.layout,.layout-wrapper,.grid,.grid-container,.dashboard-grid,.content-grid,.decision-row,.metric-grid,.shopify-grid,.organic-grid,.ad-grid,.schedule-item { display:block !important; width:100% !important; max-width:100% !important; min-width:0 !important; position:static !important; transform:none !important; } .hero,.section,.card,.panel,.decision-card,.queue-card,.pill,.badge,.status-banner,[class*="card"],[class*="section"] { width:100% !important; max-width:100% !important; min-width:0 !important; margin-left:0 !important; margin-right:0 !important; box-sizing:border-box; } .hero,.section { border-radius:18px; padding:14px; } .pill-row,.source-row,.status-row,.period-tabs { display:flex; flex-wrap:wrap; gap:8px; width:100%; max-width:100%; } .status-row .pill,.status-banner { width:100%; flex-basis:100%; justify-content:flex-start; } .pill,.status-pill,.period-tab,.status-banner { white-space:normal; overflow-wrap:anywhere; word-break:normal; } h1 { font-size:clamp(32px, 10vw, 42px); } .value { font-size:28px; } .hero::before,.hero::after,body::before,body::after,.decor,.decorative-bg,.background-shape,.bg-panel,[class*="decor"] { display:none !important; width:0 !important; } }
